...
export const WHITELABEL_CONFIGS: Record<BankId, WhitelabelConfig> = {
  default: {
    ...
    sendModeLabel: '일반 발송',
    sendModeDescription: '1인 셀러부터 기업까지, 노코드 3-Click으로 즉시 대량 발송합니다. 제휴사(연계기관) 앱 유치 시 인앱 연동 발송도 추가로 지원 가능합니다.',
    heroCtaPrimary: '이미지 1장으로 AI 템플릿 즉시 체험',
    heroCtaSecondary: '채널·인원별 요금표 확인하기',
    integrationHighlightTitle: '제휴사 앱 연동 확장성',
    integrationHighlightDesc: '인앱(In-App) 위젯 연동 구조를 설계하여, 제휴사(연계기관) 앱 유치 시 그 안에서 바로 접근·발송할 수 있도록 확장 가능합니다. 특정 외부 사이트에 종속되지 않는 유연한 구조입니다.',
