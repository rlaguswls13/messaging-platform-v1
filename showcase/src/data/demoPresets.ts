  ...
  },
  {
    ...
    channels: {
      ...
      email: {
        ...
        previewText: '국내 최고 엔지니어들이 공개하는 5.4만 TPS 메시징 아키텍처 세미나에 초대합니다.',
        bodyHtml: `<h3>2026 AI SaaS Summit VIP Invitation</h3><p>#{고객명}님, 실측 5.4만 TPS 고속 파이프라인 구축 노하우를 직접 확인하세요.</p>`,
